...
thisArray = ["Skynet","Digital Music Distribution",
...
thatArray = ["Facebook Platform","Erlang Enthusiasts","Ex-Girlfriends",
...
idea1 = thisArray[round(random() * len(thisArray))]
idea2 = thatArray[round(random() * len(thatArray))]
