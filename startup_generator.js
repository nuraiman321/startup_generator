...
// let first = _.random(0, thisArray.length)
// let second = _.random(0, thatArray.length)

// let startUpIdea = `${thisArray[first]}  ${thatArray[second]}`
// console.log(startUpIdea);


let first = thisArray[Math.floor(Math.random() * thisArray.length)];
let second = thatArray[Math.floor(Math.random() * thatArray.length)];
